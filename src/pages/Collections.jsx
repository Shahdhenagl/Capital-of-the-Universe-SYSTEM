...
import { Wallet, DollarSign, Calendar, AlertCircle, Check, Search, X, Filter } from 'lucide-react';
...
function Collections() {
  ...
  const totalOverdue = schedules
    ...
    .reduce((sum, s) => sum + ((parseFloat(s.amount_due) || 0) - (parseFloat(s.collected_amount) || 0)), 0);
  ...
  function openCollectModal(schedule) {
    ...
    const remaining = (parseFloat(schedule.amount_due) || 0) - (parseFloat(schedule.collected_amount) || 0);
    setCollectForm({
  ...
  async function handleCollect(e) {
    ...
    try {
      ...
      const amountDue = parseFloat(selectedSchedule.amount_due) || 0;
                  ...
                  <div className="card-body">
                    ...
                    <div className="form-row" style={{ marginTop: '12px' }}>
                      <div>
                        ...
                        <strong> {formatCurrency(selectedSchedule.amount_due)}</strong>
                      </div>
                      <div>
                        <span className="form-label">المتبقي:</span>
                        <strong> {formatCurrency((parseFloat(selectedSchedule.amount_due) || 0) - (parseFloat(selectedSchedule.collected_amount) || 0))}</strong>
                      </div>
                    </div>
                  </div>
                </div>
