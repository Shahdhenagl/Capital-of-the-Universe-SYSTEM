    ...
    <div className="print-only-container print-contract-multi-page install-contract" style={{ direction: 'rtl', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div className="contract-page">
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          {details?.safety?.limit_switch !== false && <div className="spec-row"><div className="spec-label">قاطع نهاية المشوار</div><div style={{ flex: 1 }}>يقوم بإيقاف مؤكد عند تجاوز الصاعدة لنهاية المشوار العلوي والسفلي <span className="red-text">FUJI YEM</span>.</div></div>}
          {details?.safety?.parachute !== false && <div className="spec-row"><div className="spec-label">البراشوت</div><div style={{ flex: 1 }}>يعمل مع الصاعدة ويتم إيقافها اتوماتيكياً عند حدوث ارتخاء أو قطع في أي من حبال الجر أو هبوط الصاعدة بأكثر من السرعة العادية - <span className="red-text">فوجي FUJI YEM</span>.</div></div>}
          {details?.safety?.revision_device !== false && <div className="spec-row"><div className="spec-label">جهاز الريفيزيون</div><div style={{ flex: 1 }}>خاص بتشغيل وإيقاف المصعد أثناء عمل الصيانة. <span className="red-text">فوجي FUJI YEM</span>.</div></div>}
          {details?.safety?.oilers !== false && <div className="spec-row"><div className="spec-label">المزايت</div><div style={{ flex: 1 }}>اتوماتيكية لتزييت السكك صعوداً وهبوطاً لتحفظ لزوجة وانسياب حركة المصعد. <span className="red-text">فوجي FUJI YEM</span>.</div></div>}
          {details?.safety?.flexible_cable !== false && <div className="spec-row"><div className="spec-label">الكابل المرن</div><div style={{ flex: 1 }}>لتوصيل الدوائر الكهربائية بين الصاعدة ولوحة التحكم (الكنترول) <span className="red-text">فوجي FUJI YEM</span>.</div></div>}
          {details?.safety?.shock_absorbers !== false && <div className="spec-row"><div className="spec-label">مخفف الصدمات</div><div style={{ flex: 1 }}>سوست لمنع إصطدام الصاعدة وثقل الموازنة بأرضية البئر الخرسانية بحيث يتناسب حجمها مع حمولة الصاعدة وارتفاع المبنى. <span className="red-text">فوجي FUJI YEM</span>.</div></div>}
          {details?.safety?.fire_brake_device !== false && <div className="spec-row"><div className="spec-label">جهاز الفرامل في حالة الحريق</div><div style={{ flex: 1 }}>للتحكم اليدوي في حالات الطوارئ أو انقطاع التيار الكهربائي موجودة في الماكينة <span className="red-text">فوجي FUJI YEM</span>.<br/>ربط المصعد مع لوحة إنذار الحريق (في حالة وجودها) بحيث يتم انزال الصاعدة إلى الدور الأرضي وإيقافها عن العمل مع فتح الباب، ويعود المصعد لحالة التشغيل عند إعادة إيقاف الإنذار.</div></div>}
        </div>
